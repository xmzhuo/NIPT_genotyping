...
#R_script_to_compare_genotype_of_NIPT_cells_with_parents
#this script will promp dialog box for input (result from S3_file.sh)

# R dependency: "gplots" , "tcltk"
...
library(gplots) 
library(tcltk)
#the annotation table for the SNPs, an example file called Supplemental Table SNP with reference allele sequence for genotyping.csv is available in Github deposit
ref_alt = tk_choose.files(default = "", caption = "Select One reference alternative allele info",
                           multi = FALSE, index = 1)
